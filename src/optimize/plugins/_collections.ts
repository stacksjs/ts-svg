/**
 * SVG element/attribute taxonomies. Reference data shared across plugins.
...
export const textElems: ReadonlySet<string> = new Set([...elemsGroups.textContent!, 'pre', 'title'])

export const pathElems: ReadonlySet<string> = new Set(['glyph', 'missing-glyph', 'path'])
...
export interface AttrsGroupsDeprecated {
  safe?: Set<string>
  unsafe?: Set<string>
}

export const attrsGroupsDeprecated: Readonly<Record<string, AttrsGroupsDeprecated>> = {
...
export interface ElemDef {
  ...
  deprecated?: { safe?: Set<string>, unsafe?: Set<string> }
  contentGroups?: Set<string>
  content?: Set<string>
}

export const elems: Readonly<Record<string, ElemDef>> = {
  'a': {
  ...
  'font': {
    ...
    deprecated: {
      unsafe: new Set(['horiz-origin-x', 'horiz-origin-y', 'vert-adv-y', 'vert-origin-x', 'vert-origin-y']),
    },
    contentGroups: new Set(['descriptive']),
  ...
  'font-face': {
    ...
    deprecated: {
      unsafe: new Set(['accent-height', 'alphabetic', 'ascent', 'bbox', 'cap-height', 'descent', 'hanging', 'ideographic', 'mathematical', 'panose-1', 'slope', 'stemh', 'stemv', 'unicode-range', 'units-per-em', 'v-alphabetic', 'v-hanging', 'v-ideographic', 'v-mathematical', 'widths', 'x-height']),
    },
    contentGroups: new Set(['descriptive']),
  ...
  'glyph': {
    ...
    deprecated: { unsafe: new Set(['arabic-form', 'glyph-name', 'horiz-adv-x', 'orientation', 'unicode', 'vert-adv-y', 'vert-origin-x', 'vert-origin-y']) },
    contentGroups: new Set(['animation', 'descriptive', 'paintServer', 'shape', 'structural']),
    content: new Set(['a', 'altGlyphDef', 'clipPath', 'color-profile', 'cursor', 'filter', 'font-face', 'font', 'foreignObject', 'image', 'marker', 'mask', 'pattern', 'script', 'style', 'switch', 'text', 'view']),
  },
  'glyphRef': {
    ...
    deprecated: { unsafe: new Set(['horiz-adv-x', 'vert-adv-y', 'vert-origin-x', 'vert-origin-y']) },
    contentGroups: new Set(['animation', 'descriptive', 'paintServer', 'shape', 'structural']),
    content: new Set(['a', 'altGlyphDef', 'clipPath', 'color-profile', 'cursor', 'filter', 'font-face', 'font', 'foreignObject', 'image', 'marker', 'mask', 'pattern', 'script', 'style', 'switch', 'text', 'view']),
  },
  'hatch': {
  ...
  'svg': {
    ...
    deprecated: {
      ...
      unsafe: new Set(['baseProfile', 'contentScriptType', 'contentStyleType', 'zoomAndPan']),
    },
    contentGroups: new Set(['animation', 'descriptive', 'paintServer', 'shape', 'structural']),
    content: new Set(['a', 'altGlyphDef', 'clipPath', 'color-profile', 'cursor', 'filter', 'font-face', 'font', 'foreignObject', 'image', 'marker', 'mask', 'pattern', 'script', 'style', 'switch', 'text', 'view']),
  },
...
export const editorNamespaces: ReadonlySet<string> = new Set([
...
export const referencesProps: ReadonlySet<string> = new Set([
  'clip-path',
  'color-profile',
  'fill',
  'filter',
...
export const inheritableAttrs: ReadonlySet<string> = new Set([
  'clip-rule',
  'color-interpolation-filters',
  'color-interpolation',
  'color-profile',
...
export const presentationNonInheritableGroupAttrs: ReadonlySet<string> = new Set([
  'clip-path',
  'display',
  'filter',
  'mask',
...
export const colorsProps: ReadonlySet<string> = new Set([
  'color',
  'fill',
  'flood-color',
  'lighting-color',
